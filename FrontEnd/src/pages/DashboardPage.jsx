function OverviewMetric({ label, value, accent = 'emerald' }) {
  ...
  return (
    <div className={`rounded-xl border border-emerald-200 p-4 ${accentMap[accent] ?? accentMap.emerald}`}>
      <p className="text-4xl font-extrabold text-emerald-900">{value}</p>
    ...
    return (
      <section className="space-y-4">
        <div className="rounded-2xl border border-emerald-200 bg-white p-4 shadow-sm">
          <p className="text-3xl font-extrabold text-emerald-950">Platform Overview</p>
        ...
        <div className="grid gap-4 xl:grid-cols-2">
          <div className="rounded-2xl border border-emerald-200 bg-white p-4 shadow-sm">
            <p className="text-2xl font-bold text-emerald-950">Account Health</p>
            ...
            <div className="mt-4 rounded-xl border border-emerald-200 bg-emerald-50 p-4">
              ...
              <p className="text-3xl font-extrabold text-emerald-900">{adminCount}</p>
              <p className="mt-3 text-sm font-semibold text-emerald-900">Consumers</p>
              <p className="text-3xl font-extrabold text-emerald-900">{consumerCount}</p>
            </div>
          </div>

          <div className="rounded-2xl border border-emerald-200 bg-white p-4 shadow-sm">
            <p className="text-2xl font-bold text-emerald-950">Recent Activity</p>
        ...
        <div className="rounded-2xl border border-emerald-200 bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between gap-4">
            <div>
              <p className="text-2xl font-bold text-emerald-950">Farmer Overview</p>
